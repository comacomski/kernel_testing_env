...
V2="$2"
#LOGS_DIR="./share/logs"
LOGS_DIR="$(realpath $(dirname $0))/../share/logs"
...
echo "--------------------------" >> $OUT_FILE
diff "$LOGS_DIR/$1/$1.dmesg_emerg" "$LOGS_DIR/$2/$2.dmesg_emerg" >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE

echo "dmesg critical regressions" >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE
diff $LOGS_DIR/$1/$1.dmesg_crit $LOGS_DIR/$2/$2.dmesg_crit >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE

echo "dmesg alert regressions" >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE
diff $LOGS_DIR/$1/$1.dmesg_alert $LOGS_DIR/$2/$2.dmesg_alert >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE

echo "dmesg err regressions" >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE
diff $LOGS_DIR/$1/$1.dmesg_err $LOGS_DIR/$2/$2.dmesg_err >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE

echo "dmesg warn regressions" >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE
diff $LOGS_DIR/$1/$1.dmesg_warn $LOGS_DIR/$2/$2.dmesg_warn >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE

echo "dmesg regressions" >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE
diff $LOGS_DIR/$1/$1.dmesg $LOGS_DIR/$2/$2.dmesg >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE

echo "dmesg_kern regressions" >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE
diff $LOGS_DIR/$1/$1.dmesg_kern $LOGS_DIR/$2/$2.dmesg_kern >> $OUT_FILE
echo "--------------------------" >> $OUT_FILE
